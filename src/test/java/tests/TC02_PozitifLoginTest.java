...
public class TC02_PozitifLoginTest {
    ...
    public void test01() {
        ...
        exercisePage2.emailBox.sendKeys(ConfigReader.getProperty("email"));
        exercisePage2.passwordBox.sendKeys(ConfigReader.getProperty("password"));
        //7. Click 'login' button
        exercisePage2.loginButonu.click();
        //8. Verify that 'Logged in as username' is visible
        Assert.assertTrue(exercisePage2.userProfil.isDisplayed());
        Driver.closeDriver();
    }
}
